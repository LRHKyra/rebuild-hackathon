  ...
  return (
    <div className="flex flex-col gap-6">
      <section className="rounded-xl border border-hairline bg-panel p-4">
        <h2 className="text-lg font-medium text-ink">Knowledge setup</h2>
        ...
        >
          ...
          <p className="text-xs text-ink-muted">PDF, Markdown (.md), or plain text (.txt)</p>
        </div>
        ...
        <div className="mt-3 flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            onClick={loadSample}
            disabled={busy}
            className="rounded-md border border-hairline bg-panel px-4 py-2 text-sm font-medium text-ink-soft hover:text-ink disabled:opacity-40"
          >
        ...
        {error && (
          <div
            role="alert"
            className="mt-3 rounded-md border border-warn-border bg-warn-soft px-3 py-2 text-sm text-warn"
          >
            <p>{error}</p>
      ...
      <section className="rounded-xl border border-hairline bg-panel p-4">
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs text-ink-muted">{cards.length} card(s)</span>
        </div>
        {cards.length === 0 ? (
